...
def get_img_preprocessor(source: str, target: str, img_size: int = 224):
    ...
    # stable-pretraining 0.1.8 calls the torchvision Transform.transform API,
    # which is unavailable in the CUDA 11.8-compatible torchvision 0.20.1.
    # Wrap torchvision's public transform interface instead.
    resize = dt.transforms.WrapTorchTransform(
        v2.Resize(img_size), source=source, target=target
    )
